...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="tee, but for pipes.", allow_abbrev=False
    )
    parser.add_argument("in_path", help="Path to read from.")
    parser.add_argument("out_paths", nargs="+", help="Path to write to.")
    parser.add_argument(
        "-k",
        "--keep-open",
        action="store_true",
